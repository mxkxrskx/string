...
START_TEST(c_normal) { testing_sprinf_c("%c", 52); }
END_TEST

START_TEST(c_flag_1) { testing_sprinf_c("%+c", 52); }
END_TEST

START_TEST(c_flag_2) { testing_sprinf_c("%010c", 52); }
END_TEST

START_TEST(c_flag_3) { testing_sprinf_c("% +10c", 52); }
END_TEST

START_TEST(c_flag_4) { testing_sprinf_c("% -52c", 52); }
END_TEST

START_TEST(c_flag_5) { testing_sprinf_c("%+010c", 52); }
END_TEST

START_TEST(c_flag_6) { testing_sprinf_c("% +010c", 52); }
END_TEST

START_TEST(c_flag_7) { testing_sprinf_c("% -04c", -52); }
END_TEST

START_TEST(c_flag_8) { testing_sprinf_c("% -+010c", 52); }
END_TEST

START_TEST(c_flag_9) { testing_sprinf_c("% 10c", -52); }
END_TEST

START_TEST(c_flag_precision_1) { testing_sprinf_c("%10.5c", -52); }
END_TEST

START_TEST(c_flag_precision_2) { testing_sprinf_c("%-10.5c", -52); }
END_TEST

START_TEST(c_flag_precision_3) { testing_sprinf_c("%-010.5c", -52); }
END_TEST

START_TEST(c_flag_precision_4) { testing_sprinf_c("% -+10.5c", 52); }
END_TEST
