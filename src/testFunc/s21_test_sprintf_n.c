...
START_TEST(n_normal) {
  testing_sprinf_n("T%%he nu%%mber of char%%acters %f writt%%en so far is: %n",
                   123.45);
}
END_TEST

START_TEST(n_flag_1) { testing_sprinf_n("Testing %n specif%fier", 0.0); }
END_TEST

START_TEST(n_flag_2) { testing_sprinf_n("T%%his %fis a test%n", 52.0); }
END_TEST

START_TEST(n_flag_3) { testing_sprinf_n("Anoth%fer test%n", 52.0); }
END_TEST

START_TEST(n_flag_4) { testing_sprinf_n("% -52f%n", 234.0); }
END_TEST

START_TEST(n_flag_5) { testing_sprinf_n("%+010f%n", 234.3232); }
END_TEST
