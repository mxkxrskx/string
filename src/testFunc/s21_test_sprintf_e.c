...
START_TEST(e_normal) { testing_sprintf_e("%e", 123456.789); }
END_TEST

START_TEST(e_flag_1) { testing_sprintf_e("%e", 0.0000023327000089); }
END_TEST

START_TEST(e_flag_2) { testing_sprintf_e("%010e", 52.0); }
END_TEST

START_TEST(e_flag_3) { testing_sprintf_e("% +10e", 52.0); }
END_TEST

START_TEST(e_flag_4) { testing_sprintf_e("% -52e", 234.0); }
END_TEST

START_TEST(e_flag_5) { testing_sprintf_e("%+010e", 234.3232); }
END_TEST

START_TEST(e_flag_6) { testing_sprintf_e("% +010e", 52.435435435); }
END_TEST

START_TEST(e_flag_7) { testing_sprintf_e("% -04e", -52.99999); }
END_TEST

START_TEST(e_flag_8) { testing_sprintf_e("% -+010e", 52.0); }
END_TEST

START_TEST(e_flag_9) { testing_sprintf_e("% 10e", -52.5315); }
END_TEST

START_TEST(e_flag_precision_1) { testing_sprintf_e("%#10.5e", -52.666666666); }
END_TEST

START_TEST(e_flag_precision_2) { testing_sprintf_e("%-10.5e", -52.0); }
END_TEST

START_TEST(e_flag_precision_3) { testing_sprintf_e("%-010.5e", -52.0); }
END_TEST
...
START_TEST(e_negative) { testing_sprintf_e("%e", -10.599999999); }
END_TEST

START_TEST(e_large_number) { testing_sprintf_e("%e", 1234567890.123); }
END_TEST
...
START_TEST(e_scientific_notation) { testing_sprintf_e("%e", 1.23e5); }
END_TEST
...
START_TEST(e_long_number) { testing_sprintf_e("%e", 12312312312.2567899); }
END_TEST
