...
START_TEST(f_normal) { testing_sprinf_f("%f", 0.0); }
END_TEST

START_TEST(f_flag_1) { testing_sprinf_f("%+f", 0.0); }
END_TEST

START_TEST(f_flag_2) { testing_sprinf_f("%010f", 52.0); }
END_TEST

START_TEST(f_flag_3) { testing_sprinf_f("% +10f", 52.0); }
END_TEST

START_TEST(f_flag_4) { testing_sprinf_f("% -52f", 234.0); }
END_TEST

START_TEST(f_flag_5) { testing_sprinf_f("%+010f", 234.3232); }
END_TEST

START_TEST(f_flag_6) { testing_sprinf_f("% +010f", 52.435435435); }
END_TEST

START_TEST(f_flag_7) { testing_sprinf_f("%f", -52.99999); }
END_TEST

START_TEST(f_flag_8) { testing_sprinf_f("% -+010f", 52.0); }
END_TEST

START_TEST(f_flag_9) { testing_sprinf_f("% 10f", -52.5315); }
END_TEST
...
START_TEST(f_flag_precision_2) { testing_sprinf_f("%-10.5f", -52.0); }
END_TEST

START_TEST(f_flag_precision_3) { testing_sprinf_f("%-010.5f", -52.0); }
END_TEST
...
START_TEST(f_negative) { testing_sprinf_f("%f", -10.599999999); }
END_TEST

START_TEST(f_large_number) { testing_sprinf_f("%f", 1234567890.123); }
END_TEST
...
START_TEST(f_scientific_notation) { testing_sprinf_f("%f", 1.23e5); }
END_TEST
