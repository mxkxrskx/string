...
START_TEST(u_normal){
    testing_sprintf_u("%u", 50);
}
END_TEST

START_TEST(u_flag_1){
    testing_sprintf_u("%u", 51);
}
END_TEST

START_TEST(u_flag_2){
    testing_sprintf_u("%010u", -52);
}
END_TEST

START_TEST(u_flag_3){
    testing_sprintf_u("%10u", -53);
}
END_TEST

START_TEST(u_flag_4){
    testing_sprintf_u("%-52u", -54);
}
END_TEST

START_TEST(u_flag_6){
    testing_sprintf_u("%-11.24u", -57);
}
END_TEST

START_TEST(u_flag_7){
    testing_sprintf_u("%-4u", -55);
}
END_TEST
...
START_TEST(u_flag_8){
    ...
    ck_assert_int_eq(sprintf(original, "%010hu", (short unsigned int)-58), s21_sprintf(s21, "%010hu", (short unsigned int)-58));
    ck_assert_str_eq(original, s21);
}
END_TEST
...
START_TEST(u_flag_9){
    ...
    ck_assert_int_eq(sprintf(original, "%10.1lu", (long unsigned int)-58), s21_sprintf(s21, "%10.1lu", (long unsigned int)-58));
    ck_assert_str_eq(original, s21);
...
START_TEST(u_flag_precision_1){
    testing_sprintf_u("%10.5u", -60);
}
END_TEST

START_TEST(u_flag_precision_2){
    testing_sprintf_u("%-10.5u", -61);
}
END_TEST
...
START_TEST(u_flag_precision_4){
    ...
    ck_assert_int_eq(sprintf(original, "%10.5hu", (short unsigned int)-63), s21_sprintf(s21, "%10.5hu", (short unsigned int)-63));
    ck_assert_str_eq(original, s21);
}
END_TEST
