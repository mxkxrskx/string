...
START_TEST(o_normal) { testing_sprintf_o("%o", 0); }
END_TEST

START_TEST(o_flag_1) { testing_sprintf_o("%#o", 52); }
END_TEST

START_TEST(o_flag_2) { testing_sprintf_o("%010o", 52); }
END_TEST

START_TEST(o_flag_3) { testing_sprintf_o("% #10o", 52); }
END_TEST

START_TEST(o_flag_4) { testing_sprintf_o("%-52o", 52); }
END_TEST

START_TEST(o_flag_5) { testing_sprintf_o("%+010o", 52); }
END_TEST

START_TEST(o_flag_6) { testing_sprintf_o("% 010o", 52); }
END_TEST

START_TEST(o_flag_7) { testing_sprintf_o("%-010o", 52); }
END_TEST

START_TEST(o_flag_8) { testing_sprintf_o("%#-10o", 52); }
END_TEST

START_TEST(o_flag_precision_1) { testing_sprintf_o("%.5o", 52); }
END_TEST

START_TEST(o_flag_precision_2) { testing_sprintf_o("%#.5o", 52); }
END_TEST

START_TEST(o_flag_precision_3) { testing_sprintf_o("%-.5o", 52); }
END_TEST

START_TEST(o_flag_precision_4) { testing_sprintf_o("%#-.5o", 52); }
END_TEST
