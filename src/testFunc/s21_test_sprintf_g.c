...
void testing_sprintf_g(const char *format, double x) {
  ...
  ck_assert_msg(strcmp(original, s21) == 0,
                "Failed: original: %s s21: %s, number : %f\n", original, s21,
                x);
}

START_TEST(g_normal) { testing_sprintf_g("%g", 1236.489); }
END_TEST

START_TEST(g_flag_1) { testing_sprintf_g("%g", 0.000002332000089); }
END_TEST

START_TEST(g_flag_2) { testing_sprintf_g("%010g", 52.0); }
END_TEST

START_TEST(g_flag_3) { testing_sprintf_g("% +10g", 52.0); }
END_TEST

START_TEST(g_flag_4) { testing_sprintf_g("%-52g", 234.0); }
END_TEST

START_TEST(g_flag_5) { testing_sprintf_g("%+010g", 234.3232); }
END_TEST

START_TEST(g_flag_6) { testing_sprintf_g("% +010g", 52.435435435); }
END_TEST

START_TEST(g_flag_7) { testing_sprintf_g("% -04g", -52.99); }
END_TEST

START_TEST(g_flag_8) { testing_sprintf_g("% -+010g", 52.0); }
END_TEST

START_TEST(g_flag_9) { testing_sprintf_g("% 10g", -52.5315); }
END_TEST

START_TEST(g_flag_precision_1) { testing_sprintf_g("%.5g", -52.666666666); }
END_TEST

START_TEST(g_flag_precision_2) { testing_sprintf_g("%-10.5g", -52.0); }
END_TEST

START_TEST(g_flag_precision_3) { testing_sprintf_g("%-010.5g", -52.0); }
END_TEST
...
START_TEST(g_negative) { testing_sprintf_g("%g", -10.599999999); }
END_TEST

START_TEST(g_large_number) { testing_sprintf_g("%g", 1234567890.123); }
END_TEST
...
START_TEST(g_long_number) { testing_sprintf_g("%g", 12312312312.2567899); }
END_TEST
...
START_TEST(g_small_num) { testing_sprintf_g("%g", 0.00000000123456789); }
END_TEST

START_TEST(g_neg_small_num) { testing_sprintf_g("%g", -0.00000000123456789); }
END_TEST

START_TEST(g_large_exponential_pos) { testing_sprintf_g("%g", 5.67e12); }
END_TEST

START_TEST(g_large_exponential_neg) { testing_sprintf_g("%g", -3.21e-15); }
END_TEST

START_TEST(g_very_large_pos) { testing_sprintf_g("%g", 1.23e30); }
END_TEST

START_TEST(g_very_large_neg) { testing_sprintf_g("%g", -9.87e-25); }
END_TEST
