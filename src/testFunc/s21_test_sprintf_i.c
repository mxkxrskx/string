...
START_TEST(i_flag_2){
    testing_sprinf_i("%010i", 52);
}
END_TEST

START_TEST(i_flag_3){
    testing_sprinf_i("% +10i", 52);
}
END_TEST

START_TEST(i_flag_4){
    testing_sprinf_i("% -52i", 52);
}
END_TEST

START_TEST(i_flag_7){
    testing_sprinf_i("% -04i", -52);
}
END_TEST
...
START_TEST(i_flag_precision_1){
    testing_sprinf_i("%10.5i", -52);
}
END_TEST

START_TEST(i_flag_precision_2){
    testing_sprinf_i("%-10.5i", -52);
}
END_TEST

START_TEST(i_flag_precision_3){
    testing_sprinf_i("%-010.5i", -52);
}
END_TEST

START_TEST(i_flag_precision_4){
    testing_sprinf_i("% -+10.5i", 52);
}
END_TEST

START_TEST(test_sprintf_i_INT_MIN) {
    testing_sprinf_i("%i", INT_MIN);
}
END_TEST
